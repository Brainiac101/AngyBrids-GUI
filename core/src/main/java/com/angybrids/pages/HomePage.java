...
public class HomePage implements Screen {
    ...
    public void render(float delta) {
        ...
        if(play.getButtonSprite().getBoundingRectangle().contains(touchX, touchY)) Gdx.graphics.setSystemCursor(Cursor.SystemCursor.Hand);
        else Gdx.graphics.setSystemCursor(Cursor.SystemCursor.Arrow);

        if (Gdx.input.justTouched() && play.getButtonSprite().getBoundingRectangle().contains(touchX, touchY))
